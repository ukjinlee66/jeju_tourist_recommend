...
# 관광지명 불러오기
def open_excel():
    df = pd.read_csv('/Users/lyk/airflow/dags/tourist.csv', encoding='CP949')
    new_list = []
    for i in df["제목"]:
        new_list.append(i)
    return new_list
...
def crawl():
    ...
    driver = webdriver.Chrome('/Users/lyk/airflow/dags/chromedriver', options=webdriver_options)
    ...
    for searchKeyword in tourlist:
        ...
        while cnt < 57:
            ...
            f = open(f"/Users/lyk/airflow/dags/{crawlDate}_brunch.csv", "a", encoding="UTF-8", newline='')
